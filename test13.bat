...
echo/
"7zip\7z.exe" a "%TEMP%\buffer-zip\%text%.zip" "C:\Users\%USERPROFILE%\Desktop\%DESKFOLDERNAME%\papers" -bso0 -bsp0
ROBOCOPY "%TEMP%\buffer-zip" "C:\Users\%USERPROFILE%\Desktop\%DESKFOLDERNAME%\papers-archive" *.zip /COPYALL /R:0 /MT[:4] /NFL /NDL /NJH /NJS
...
sleep 3
del /s /q "C:\Users\%USERPROFILE%\Desktop\%DESKFOLDERNAME%\papers\" *.pdf
