...
echo/
"7Zip\7z.exe" a "%TEMP%\buffer-pdf\%text%.zip" "config\" -bso0 -bsp0

echo [92mZip file made.[0m

sleep 3

"rclone\rclone.exe" move --progress-terminal-title --progress --stats-one-line "%TEMP%\buffer-pdf\%text%.zip" GoogleD:"/test"
